  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('Login/home'); ?>">
        <div>
        <img src="https://cdn.pixabay.com/photo/2017/09/23/21/21/label-2780146_1280.png" alt="" width="70%" style="margin-bottom: 15px; margin-top: 15px">
        </div>
        <div class="sidebar-brand-text mx-3">Metode MAUT</div>
      </a>
